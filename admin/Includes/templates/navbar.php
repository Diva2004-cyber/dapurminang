            ...
            <ul class="menu-bar">
                ...
                <li>
                    <a href="orders.php" class="a-verMenu orders_link">
                        ...
                        <span style="padding-left:6px;">Manage Orders</span>
                    </a>
                </li>
                <li>
                    <a href="reservations.php" class="a-verMenu reservations_link">
                        <i class="fas fa-calendar-check icon-ver"></i>
                        <span style="padding-left:6px;">Daftar Reservasi</span>
                    </a>
                </li>
                <li>
                    <a href="verify_payment.php" class="a-verMenu verify_payment_link">
                        <i class="fas fa-money-check-alt icon-ver"></i>
                        <span style="padding-left:6px;">Verifikasi Pembayaran</span>
                    </a>
                </li>
                <li>
                    <a href="vouchers.php" class="a-verMenu vouchers_link">
                        <i class="fas fa-ticket-alt icon-ver"></i>
                        <span style="padding-left:6px;">Voucher</span>
                    </a>
                </li>
                <li>
                    <a href="calculate_shipping.php" class="a-verMenu calculate_shipping_link">
                        <i class="fas fa-truck icon-ver"></i>
                        <span style="padding-left:6px;">Hitung Ongkir</span>
                    </a>
                </li>
