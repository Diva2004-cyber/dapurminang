    	...
    	?>
            ...
            <div class="card" style = "margin: 20px 10px">
                ...
                <div class="card-header tab" style="padding:0px;">
                    ...
                    <button class="tablinks_orders" onclick="openTab(event, 'reservations','tabcontent_orders','tablinks_orders')">Reservations</button>
                </div>
                ...
                <div class="card-body">
                    <div class='responsive-table'>
                                    ...
                                    else
                                    {
                                        ...
                                        foreach($placed_orders as $order)
                                        {
                                            echo "<tr>";
                                                ...
                                                $total_with_shipping = ($total_price * 1000) + $order['shipping_cost'];
                                                echo "Rp " . number_format($total_with_shipping, 0, ',', '.');
                                                echo "</td>";
                                                echo "<td>";
                                                    ?>
                        ...
                        <!-- RESERVATIONS -->
                        <table class="table X-table tabcontent_orders" id="reservations" style="display:none">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php
                                    $stmt = $con->prepare("SELECT r.*, c.client_name, c.client_email, c.client_phone 
                                                         FROM reservations r 
                                    ...
                                    if(count($reservations) == 0) {
                                        ...
                                        foreach($reservations as $reservation) {
                                            echo "<tr>";
                                            echo "<td>" . date('Y-m-d H:i', strtotime($reservation['selected_time'])) . "</td>";
                                            echo "<td>Meja " . $reservation['table_id'] . "</td>";
                                            echo "<td>" . $reservation['nbr_guests'] . "</td>";
                                            echo "<td>" . $reservation['client_name'] . "<br>" . $reservation['client_email'] . "<br>" . $reservation['client_phone'] . "</td>";
                                            echo "<td>" . ucfirst($reservation['status']) . "</td>";
                                            echo "<td>
                                                    <a href='reservations.php?reservation_id=" . $reservation['reservation_id'] . "' class='btn btn-primary btn-sm'>
            ...
            <div class="card" style = "margin: 20px 10px">
                <!-- TABS BUTTONS -->
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_reservations active" onclick="openTab(event, 'upcoming_reservations','tabcontent_reservations','tablinks_reservations')">Upcoming Reservations</button>
                ...
                <div class="card-body">
                    <div class='responsive-table'>
                        ...
                        <table class="table X-table tabcontent_reservations" id="upcoming_reservations" style="display:table">
                            <thead>
                                <tr>
                                    <th>Reservation Date</th>
                                    <th>Table Number</th>
                            ...
                            <tbody>
                                <?php
                                    $stmt = $con->prepare("SELECT r.* 
                                                         ...
                                                         AND r.selected_time > NOW() 
                                                         ORDER BY r.selected_time ASC");
                                    $stmt->execute();
                                    $reservations = $stmt->fetchAll();
                                    
                                    if(count($reservations) == 0) {
                                        echo "<tr><td colspan='6' style='text-align:center;'>No upcoming reservations</td></tr>";
                                    } else {
                                        foreach($reservations as $reservation) {
                                            echo "<tr>";
                                            echo "<td>" . date('Y-m-d H:i', strtotime($reservation['selected_time'])) . "</td>";
                        ...
                        <table class="table X-table tabcontent_reservations" id="completed_reservations" style="display:none">
                            <thead>
                                <tr>
                                    <th>Reservation Date</th>
                                    <th>Table Number</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(count($reservations) == 0) {
                                        echo "<tr><td colspan='5' style='text-align:center;'>No completed reservations</td></tr>";
                                    } else {
                                        foreach($reservations as $reservation) {
                                            echo "<tr>";
                                            echo "<td>" . date('Y-m-d H:i', strtotime($reservation['selected_time'])) . "</td>";
                        ...
                        <table class="table X-table tabcontent_reservations" id="canceled_reservations" style="display:none">
                            <thead>
                                <tr>
                                    <th>Reservation Date</th>
                                    <th>Table Number</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(count($reservations) == 0) {
                                        echo "<tr><td colspan='6' style='text-align:center;'>No canceled reservations</td></tr>";
                                    } else {
                                        foreach($reservations as $reservation) {
                                            echo "<tr>";
                                            echo "<td>" . date('Y-m-d H:i', strtotime($reservation['selected_time'])) . "</td>";
                                            ...
                                            echo "<td>" . $reservation['client_name'] . "<br>" . $reservation['client_email'] . "<br>" . $reservation['client_phone'] . "</td>";
                                            echo "<td>" . ucfirst($reservation['status']) . "</td>";
                                            echo "<td>" . ($reservation['cancellation_reason'] ?? 'No reason provided') . "</td>";
                                            echo "</tr>";
                                        }
                                    }
                                ?>
