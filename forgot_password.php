...
<head>
    ...
    <title>Lupa Password - DAPOER MINANG</title>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="reset-container">
            ...
            <form action="process_forgot_password.php" method="POST">
                ...
                <button type="submit" class="btn btn-reset mb-3">Kirim Kode OTP</button>
                <div class="text-center">
                    <p>Ingat password? <a href="login.php" class="login-link">Login Sekarang</a></p>
                </div>
            </form>
        </div>
    </div>
